import { CustomVideoJSTexture } from "./CustomTexture";

const { regClass, property } = Laya;

@regClass()
export class CustomVideoJSPlayer extends Laya.Sprite {
    private _videoTexture: CustomVideoJSTexture;
    ...
    private get videoTexture(): CustomVideoJSTexture {
        return this._videoTexture;
    }

    private set videoTexture(value: CustomVideoJSTexture) {
    ...
    public set source(value: string) {
        if (value) {
            if (!this._videoTexture) {
                this.videoTexture = new CustomVideoJSTexture(this.videoID);
            }
