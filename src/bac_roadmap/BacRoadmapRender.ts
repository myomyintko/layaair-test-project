...
const bacResultImgData2: bacResultImgs2 = {
    // banker
    bacData1ResultDom1: "resources/game_icons/type61.png",
    bacData1ResultDom9: "resources/game_icons/type62.png",
    bacData1ResultDom17: "resources/game_icons/type63.png",
...
export class BacRoadmapRender extends BacRoadmapRenderBase {
    ...
    private bacHistory: BacHistory = null
    private bacRoadmap: BacRoadmap
    ...
    private loadHistoryData() {
        this.bacHistory = new BacHistory()
        let tempArr: number[] = []
        // historyData.resultObjArr.forEach(result => {
        //     const { bankerCardValues, playerCardValues } = this.bacHistory.ParseResultContent(result.resultContent);
        //     const resultNumber = this.bacHistory.CalculateHistoryResult(bankerCardValues, playerCardValues)
        //     tempArr.push(resultNumber)
        // })
        this.bacRoadmap = new BacRoadmap(tempArr)
    }

    AddResult(content: string) {
        if (!this.bacRoadmap) {
            this.bacRoadmap = new BacRoadmap()
        }
        // const { bankerCardValues, playerCardValues } = this.bacHistory.ParseResultContent(content);
        // console.log('gg: ',bankerCardValues, playerCardValues)
        // const resultNumber = this.bacHistory.CalculateHistoryResult(bankerCardValues, playerCardValues)
        // console.log('resultNumber: ', resultNumber)
        this.bacRoadmap.push(34)
        // console.clear()
        console.log(this.bacRoadmap.breadplate.matrix)
        console.log(this.bacRoadmap.bigRoad.matrix)
        this.SetHistoryData()
    }
    ...
    SetHistoryData() {
        if (this.currentUI === "icon") {
            this.GetHistoryFragment1(this.bacRoadmap.breadplate.matrix, this.breadPlateCols, this.roadmapRows, this.bead_plate_road_panel, this.SetHistoryItem1)
        } else if (this.currentUI === "point") {
            this.GetHistoryFragment1(this.bacRoadmap.breadplate.matrix2, this.breadPlateCols, this.roadmapRows, this.bead_plate_road_panel, this.SetHistoryItem6)
        }
        this.GetHistoryFragment2(this.bacRoadmap.bigRoad.matrix, this.bigRoadCols, this.roadmapRows, this.big_road_panel, this.SetHistoryItem2)
        this.GetHistoryFragment2(this.bacRoadmap.bigEyeBoy.matrix, this.bigEyeRoadCols, this.roadmapRows, this.big_eye_road_panel, this.SetHistoryItem3)
        this.GetHistoryFragment2(this.bacRoadmap.smallRoad.matrix, this.smallRoadCols, this.roadmapRows, this.small_road_panel, this.SetHistoryItem4)
        this.GetHistoryFragment2(this.bacRoadmap.cockroachPig.matrix, this.cockroachRoadCols, this.roadmapRows, this.cockroach_road_panel, this.SetHistoryItem5)
    }
    ...
    //         const dataArr1PlayerAsk = this.bacRoadmap.breadplate.matrix.slice()
    //         dataArr1PlayerAsk.push(2)
    //         const dataArr2PlayerAsk = this.AddOneResultToArr2(this.bacRoadmap.bigRoad.matrix, 2)
    //         const dataArr3PlayerAsk = this.AddOneResultToArr2(this.bacRoadmap.bigEyeBoy.matrix, historyData.playerAsk3)
    ...
    //         const dataArr1BankerAsk = this.bacRoadmap.breadplate.matrix.slice()
    //         dataArr1BankerAsk.push(1)
    //         const dataArr2BankerAsk = this.AddOneResultToArr2(this.bacRoadmap.bigRoad.matrix, 1)
    //         const dataArr3BankerAsk = this.AddOneResultToArr2(this.bacRoadmap.bigEyeBoy.matrix, historyData.bankerAsk3)
